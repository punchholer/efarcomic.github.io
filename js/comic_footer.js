document.querySelector(".writeFooter").innerHTML = `
    <footer align="center">
       ...
       <div id="social-icons">
            ...
            <a href="https://www.youtube.com/channel/UCq02sauux-1yqpIly8wI7Nw" target="_blank"><img src="img/icons/youtube-icon.png" alt="Youtube"></a>
            <a href="https://efarcomic.com/rss.xml" target="_blank"><img src="img/icons/rss-icon.png" alt="RSS"></a>
